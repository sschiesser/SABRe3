 ...
 *        underlaying stack.
 *
 * $Id: app_config.h 27459 2011-06-23 13:48:37Z yogesh.bellan $
 *
...
typedef enum
{
    ...
    APP_TIMER_TX_DATA = (APP_FIRST_TIMER_ID),

    /** Application timer id used to switch off LED */
    APP_TIMER_LED_OFF = (APP_FIRST_TIMER_ID + 1),
	
	/** Application timer id used for broadcasting data */
	APP_TIMER_BC_DATA = (APP_FIRST_TIMER_ID + 2),
	
	/** Application timer id used for payload update */
	APP_TIMER_BCN_PAYLOAD_UPDATE = (APP_FIRST_TIMER_ID + 3)
