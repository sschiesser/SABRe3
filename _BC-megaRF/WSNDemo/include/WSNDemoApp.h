/***************************************************************************//**
  ...
  \internal
  Last change:
    $Id: WSNDemoApp.h 20719 2012-03-30 16:27:17Z dkolmakov $
*******************************************************************************/
...
// Security parameters
#define DEVICE1_EXT_ADDR      0x1ULL
...
#ifndef APP_TIMER_END_DEVICE_MIN_WAKEFUL_TIME
#define APP_TIMER_END_DEVICE_MIN_WAKEFUL_TIME  500UL
#endif
...
typedef struct _SpecialDeviceInterface_t
{
  ...
  void (*appDeviceWakeUpInd)(void);
  AppCommandDescriptor_t FLASH_PTR *appDeviceCmdDescTable;
