...
//-----------------------------------------------
  ...
  #define APP_DEVICE_CAPTION "SABRe_coord"
#endif

//-----------------------------------------------
//BOARD_DERFNODE
//-----------------------------------------------
#ifdef BOARD_DERFNODE
...
//  Persistent: Yes
#define CS_CHANNEL_MASK (1L<<0x0e)
...
//  Persistent: No
#define CS_END_DEVICE_SLEEP_PERIOD 5000L
